    ...
    <v-app-bar color="#02218f" class="pt-3" height="fit-content" absolute>
      <v-container fluid>
        <v-row>
          ...
          <v-col cols="4">
            <div
              class="parent text-white d-flex justify-lg-space-between align-center ga-4"
            >
              <div class="avilable">
                <span>Available 27/4 at</span>
                <br />
                <strong>155-991-4735</strong>
              </div>
              <div class="wishlist d-flex flex-column align-center">
                ...
                <span style="color: #ffb457">Favorites</span>
              </div>
              <div class="Sign-in d-flex flex-column align-center">
                ...
                <span style="color: #ffb457">Sign In</span>
              </div>
              <div
              ...
              >
                ...
                <span style="color: #ffb457">Cart</span>
              </div>
            </div>
          </v-col>
          <v-col cols="5">
